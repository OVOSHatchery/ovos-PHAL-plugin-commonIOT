            ...
            RowLayout {
                ...
                Button {
                    ...
                    onClicked: {
                        ...
                        if(device.state == "off") {
                            Mycroft.MycroftController.sendRequest("ovos.iot.device.turn_on", { "device_id": device.id })
                        }
                        else {
                            Mycroft.MycroftController.sendRequest("ovos.iot.device.turn_off", { "device_id": device.id })
                        }
                    }
                ...
                Button {
                    ...
                    onClicked: {
                        Mycroft.MycroftController.sendRequest("ovos.iot.call.supported.function", {
                            "device_id": device.id,
